            ...
            <div class="w3-card-4">
                ...
                <form class="w3-container" method="POST">
                    <fieldset>
                        ...
                        <input class="w3-input w3-round" type="text" name="id" required/>
                        <label>Name</label>
                        <input class="w3-input w3-round" type="text" name="Designacao" required/>
                    </fieldset>
    ...
    <div class="container">
        <div class="w3-card-4">
            ...
            <form class="form-container" method="POST">
                <fieldset>
                    <label>ID</label>
                    <input type="text" name="id" readonly value="${periodo.id}"/>
                    <label>Nome</label>
                    <input type="text" name="Designacao" value="${periodo.Designacao}"/>
                </fieldset>
            ...
            <footer class="card-header">
                <h5>Generated by a100696::EngWeb2024 in ${d} - [<a href="/Periodos">Regressar</a>]</h5>
            </footer>
